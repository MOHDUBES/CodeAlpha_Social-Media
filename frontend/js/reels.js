      ...
      <div class="reel-container" data-id="${reel.id}">
        ...
        <div class="top-controls">
          <div class="top-controls-left">
            <button class="control-btn" onclick="togglePlay(this.closest('.reel-container').querySelector('video'))">
              <i class="fas fa-play" style="font-size: 14px;"></i>
            </button>
            <button class="control-btn" onclick="toggleMute(this.closest('.reel-container').querySelector('video'), this)">
              <i class="fas fa-volume-up" style="font-size: 14px;"></i>
            </button>
          </div>
          <div class="top-controls-right">
            <button class="control-btn" onclick="showToast('More options coming soon', 'info')">
        ...
        <div class="reel-overlay">
          ...
          <div class="reel-actions">
            <div class="reel-action-wrapper">
              <button class="reel-action-btn ${reel.hasLiked ? 'liked' : ''}" onclick="toggleLikeReel('${reel.id}', this.parentElement)">
                <i class="${reel.hasLiked ? 'fas' : 'far'} fa-heart"></i>
              </button>
              <span class="like-count">${reel.likeCount || 0}</span>
            </div>
            
            <div class="reel-action-wrapper">
              <button class="reel-action-btn" onclick="showToast('Dislike recorded', 'info')">
            ...
            <div class="reel-action-wrapper">
              <button class="reel-action-btn" onclick="openCommentsModal('${reel.id}')">
            ...
            <div class="reel-action-wrapper">
              <button class="reel-action-btn" onclick="showToast('Remix feature coming soon!', 'info')">
                <i class="fas fa-shuffle remix-icon" style="font-size: 16px;"></i>
              </button>
              <span>Remix</span>
            </div>

            <div class="reel-action-wrapper" style="margin-top: 8px;">
              <img src="${reel.user.profilePic}" class="reel-avatar" onerror="handleImageError(this)" onclick="window.location.href='/profile.html?id=${reel.user.id}'">
            </div>
          </div>
        </div>
      </div>
